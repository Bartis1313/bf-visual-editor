...
enum TwinkleNavigationState
{
    ...
    NavigationState_FrontEnd, //0x0001
    NavigationState_LoadingScreen, //0x0002
    NavigationState_InGameMenu, //0x0003
    NavigationState_EndOfRound //0x0004
};
...
enum SpartaOnlineEnvironment
{
    ...
    SpartaOnlineEnvironment_Test, //0x0001
    SpartaOnlineEnvironment_Certification, //0x0002
    SpartaOnlineEnvironment_Production, //0x0003
    SpartaOnlineEnvironment_Count //0x0004
};
...
enum SpartaInteractiveNotificationActions
{
    ...
    SpartaNotificationAction_Read //0x0001
};
...
enum SpartaMenuVOMother
{
    ...
    VO_SpartaMenuWelcomeToBF, //0x0001
    VO_SpartaMenuWelcomeMorning, //0x0002
    VO_SpartaMenuWelcomeAfternoon, //0x0003
    VO_SpartaMenuWelcomeEvening, //0x0004
    VO_SpartaMenuWorkingAnalyzingPlayStyle, //0x0005
    VO_SpartaMenuWorkingCreateRecommendation, //0x0006
    VO_SpartaMenuWorkingWillAnalyze, //0x0007
    VO_SpartaMenuTipRecommendPlayer, //0x0008
    VO_SpartaMenuTipFindFriends, //0x0009
    VO_SpartaMenuTipFindFriend, //0x000A
    VO_SpartaMenuTipNewNotification, //0x000B
    VO_SpartaMenuTipNewNotifications, //0x000C
    VO_SpartaMenuTipFriendsArePlaying, //0x000D
    VO_SpartaMenuTipCloseToRankUp, //0x000E
    VO_SpartaMenuTipNewWaysToPlayMP, //0x000F
    VO_SpartaMenuTipOperations, //0x0010
    VO_SpartaMenuTipCustomGames, //0x0011
    VO_SpartaMenuTip, //0x0012
    VO_SpartaMenu_Count //0x0013
};
...
enum SpartaPresenceUserTitleInfoEvent
{
    ...
    SpartaPresenceUserTitleInfoEvent_GetUser, //0x0001
    SpartaPresenceUserTitleInfoEvent_GetCachedUsers //0x0002
};
...
enum SpartaMatchmakingResult
{
    ...
    SpartaMatchmakingResult_Failure, //0x0001
    SpartaMatchmakingResult_Timeout //0x0002
};
...
enum SpartaMatchmakingRequestEvent
{
    ...
    SpartaMatchmakingRequestEvent_CancelMatchmaking //0x0001
};
...
enum SpartaUserProfileImageSize
{
    ...
    SpartaUserProfileImageSize_Medium, //0x0001
    SpartaUserProfileImageSize_Large //0x0002
};
...
enum SpartaPartyResponseResult
{
    ...
    SpartaPartyResponseResult_Cancelled, //0x0001
    SpartaPartyResponseResult_Failure, //0x0002
    SpartaPartyResponseResult_FailureNoParty, //0x0003
    SpartaPartyResponseResult_FailureNoMpPrivilege, //0x0004
    SpartaPartyResponseResult_FailurePartyIsFull, //0x0005
    SpartaPartyResponseResult_Unknown, //0x0006
    SpartaPartyResponseResult_Count //0x0007
};
...
enum SpartaPartyResponseEvent
{
    ...
    SpartaPartyResponseEvent_PartyUpdated, //0x0001
    SpartaPartyResponseEvent_PartyMembersRetrieved, //0x0002
    SpartaPartyResponseEvent_CreatePartyResponse, //0x0003
    SpartaPartyResponseEvent_LeavePartyResponse, //0x0004
    SpartaPartyResponseEvent_JoinPartyResponse, //0x0005
    SpartaPartyResponseEvent_SendInvitesResponse, //0x0006
    SpartaPartyResponseEvent_SwitchUser, //0x0007
    SpartaPartyResponseEvent_GetPartyGameIdResponse, //0x0008
    SpartaPartyResponseEvent_GetLocalUserResponse, //0x0009
    SpartaPartyResponseEvent_GetUserProfilesResponse, //0x000A
    SpartaPartyResponseEvent_GetServerDetailsResponse //0x000B
};
...
enum SpartaPartyRequestEvent
{
    ...
    SpartaPartyRequestEvent_LeaveParty, //0x0001
    SpartaPartyRequestEvent_GetPartyMembers, //0x0002
    SpartaPartyRequestEvent_GetPartyGameId, //0x0003
    SpartaPartyRequestEvent_SendInvites, //0x0004
    SpartaPartyRequestEvent_JoinGameSession, //0x0005
    SpartaPartyRequestEvent_LeaveGameSession, //0x0006
    SpartaPartyRequestEvent_StartMatchMaking, //0x0007
    SpartaPartyRequestEvent_GetLocalUser, //0x0008
    SpartaPartyRequestEvent_GetUserProfiles, //0x0009
    SpartaPartyRequestEvent_GetServerDetails //0x000A
};
...
enum DisconnectionType
{
    ...
    DisconnectionType_Server, //0x0001
    DisconnectionType_Presence //0x0002
};
...
enum CommerceCheckoutStatus
{
    ...
    CommerceCheckoutStatus_Cancelled, //0x0001
    CommerceCheckoutStatus_Error, //0x0002
    CommerceCheckoutStatus_OIG_Disabled //0x0003
};
...
enum OriginPartyType
{
    ...
    OriginPartyType_Private, //0x0001
    OriginPartyType_Count //0x0002
};
...
enum UIInputAction
{
    ...
    UIInputAction_TwinkleBegin, //0x0050
    UIInputAction_ReloadTwinkle, //0x0051
    UIInputAction_TwinkleAccept, //0x0052
    UIInputAction_TwinkleDecline, //0x0053
    UIInputAction_TwinkleOption1, //0x0054
    UIInputAction_TwinkleOption2, //0x0055
    UIInputAction_TwinkleOption3, //0x0056
    UIInputAction_TwinkleOption4, //0x0057
    UIInputAction_TwinklePrevious, //0x0058
    UIInputAction_TwinkleNext, //0x0059
    UIInputAction_TwinkleHome, //0x005A
    UIInputAction_TwinkleEnd, //0x005B
    UIInputAction_TwinkleUp, //0x005C
    UIInputAction_TwinkleDown, //0x005D
    UIInputAction_TwinkleLeft, //0x005E
    UIInputAction_TwinkleRight, //0x005F
    UIInputAction_TwinkleSelect, //0x0060
    UIInputAction_TwinkleStart, //0x0061
    UIInputAction_TwinkleScrollUp, //0x0062
    UIInputAction_TwinkleScrollDown, //0x0063
    UIInputAction_TwinkleFinish, //0x0064
    UIInputAction_Size, //0x0065
    UIInputAction_None //0x0066
};
...
enum UITouchEventType
{
    ...
    UITouchEventType_Move, //0x0001
    UITouchEventType_End //0x0002
};
...
enum InputConceptIdentifiers
{
    ...
    ConceptTwinkleReload, //0x00E9
    ConceptTwinkleAccept, //0x00EA
    ConceptTwinkleDecline, //0x00EB
    ConceptTwinkleOption1, //0x00EC
    ConceptTwinkleOption2, //0x00ED
    ConceptTwinkleOption3, //0x00EE
    ConceptTwinkleOption4, //0x00EF
    ConceptTwinklePrevious, //0x00F0
    ConceptTwinkleNext, //0x00F1
    ConceptTwinkleHome, //0x00F2
    ConceptTwinkleEnd, //0x00F3
    ConceptTwinkleUp, //0x00F4
    ConceptTwinkleDown, //0x00F5
    ConceptTwinkleLeft, //0x00F6
    ConceptTwinkleRight, //0x00F7
    ConceptTwinkleSelect, //0x00F8
    ConceptTwinkleStart, //0x00F9
    ConceptTwinkleScrollUp, //0x00FA
    ConceptTwinkleScrollDown, //0x00FB
    ConceptUndefined, //0x00FC
    ConceptSize //0x00FD
};
...
enum ExitToMenuReason
{
    ...
    ExitToMenuReason_KickedViaPunkBuster, //0x0009
    ExitToMenuReason_KickedViaFairFight, //0x000A
    ExitToMenuReason_Banned, //0x000B
    ExitToMenuReason_InteractivityTimeout, //0x000C
    ExitToMenuReason_KickedOutServerFull, //0x000D
    ExitToMenuReason_ESportsMatchStarting, //0x000E
    ExitToMenuReason_NotInESportsRosters, //0x000F
    ExitToMenuReason_ESportsMatchEnding, //0x0010
    ExitToMenuReason_VirtualServerExpired, //0x0011
    ExitToMenuReason_VirtualServerRecreate, //0x0012
    ExitToMenuReason_ESportsTeamFull, //0x0013
    ExitToMenuReason_ESportsMatchAborted, //0x0014
    ExitToMenuReason_ESportsMatchWalkover, //0x0015
    ExitToMenuReason_ESportsMatchWarmupTimedOut, //0x0016
    ExitToMenuReason_WantToConnectToOnline, //0x0017
    ExitToMenuReason_KickedOutRankTooHigh //0x0018
};
...
enum DiceUIAnalogPadType
{
    ...
    DiceUIAnalogPadType_RightStick, //0x0001
    DiceUIAnalogPadType_LeftTrigger, //0x0002
    DiceUIAnalogPadType_RightTrigger, //0x0003
    DiceUIAnalogPadType_Count //0x0004
};
...
enum DiceUIAnalogStick
{
    ...
    DiceUIAnalogStick_Right //0x0001
};
...
enum UIPopupType
{
    ...
    PopupType_TwinkleRollback, //0x001B
    PopupType_TwinkleSignatureFailure //0x001C
};
