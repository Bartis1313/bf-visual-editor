...
class VoipEntity;
class TwinkleUISettings;
class TwinkleUIConfiguration;
class TwinkleStaticBundlesAsset;
class UIWidgetEntityData;
class TwinkleUIWidgetEntityData;
class UICppScreenData;
class TwinkleBundledVideos;
class TwinkleTtfAsset;
class TwinkleEnabledEntityData;
class TwinkleOverlayEntityData;
class TwinkleBundleAsset;
class UIWidgetEntity;
class TwinkleOverlayEntity;
class TwinkleTtfFontData;
class TwinkleEnabledEntity;
class TwinkleUIWidgetEntity;
...
class SpartaInputDebuggingWidgetData;
class SpartaUIWidgetEntityData;
class SpartaUIOnlineEntityData;
class SpartaAudioEffectsAsset;
class SpartaSoundSettings;
class SpartaExtensionSettings;
class SpartaGatewaySettings;
class SpartaStreamingInstallEntityData;
class SpartaMenuVOEntityData;
class SpartaEndOfRoundEntityData;
class SpartaInGameEntityData;
class SpartaWarsawFrontEndEntityData;
class SpartaFrontEndAudioEntityData;
class SpartaFrontEndCoreEntityData;
class PresenceBackendData;
class SpartaBundleAsset;
class SpartaDataAsset;
class UIElementEntityData;
class SpartaTextElementEntityData;
class TunguskaGlobeEntityData;
class PresenceBackend;
class SpartaWarsawFrontEndEntity;
class SpartaFrontEndCoreEntity;
class SpartaFrontEndAudioEntity;
class SpartaUIOnlineEntity;
class ToolData;
...
class PresenceLeavePartyRequestParameters;
class PresenceAcceptPartyInviteRequestParameters;
class PresenceSendPartyInvitesRequestParameters;
class PresenceCreatePartyRequestParameters;
class PresenceGetUserProfilesRequestParameters;
...
class PresenceCreateOrJoinPlaygroupRequestParameters;
...
class PresenceAcceptFriendRequestParameters;
...
class PresenceUserProfileServiceData;
...
class SpartaPresenceBackendData;
...
class SpartaOriginPresenceBackend;
...
class SpartaVideoElementEntityData;
class TwinkleUIWidgetData;
...
class PresencePartyServiceData;
...
class PasswordInputHandlerEntityData;
...
class PresenceGetUsersDataRequestParameters;
...
class ClientPasswordInputHandlerEntity;
